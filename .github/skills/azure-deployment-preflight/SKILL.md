...
Optional, when available in the workspace:

- **Microsoft Learn MCP** (`microsoft_docs_search` / `microsoft_docs_fetch`) - For documentation lookups
- **Bicep MCP** (`bicep_m_*`, `bicepschema`) - For resource schema and best-practice lookups
